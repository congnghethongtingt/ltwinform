...
AS 
BEGIN
	SELECT t.InvoiceNo AS [Số HĐ], b.totalPrice AS [Thành tiền], OrderDate AS [Ngày đặt hàng], DeliveryDate AS [Ngày giao hàng]
	FROM dbo.Product AS b,dbo.Invoice AS t
	WHERE OrderDate >= @orderDate AND DeliveryDate <= @deliveryDate
END
GO

EXEC 

ALTER TABLE ADD totalPrice FLOAT
...
[SellPrice]) VALUES (N'Product1', N'S n ph m 1', N'Cái', CAST(100000 AS
Decimal(18, 0)), CAST(120000 AS Decimal(18, 0)))
INSERT [dbo].[Product] ([ProductID], [ProductName], [Unit], [BuyPrice],
[SellPrice]) VALUES (N'Product2', N'S n ph m 2', N'Cái', CAST(90000 AS
Decimal(18, 0)), CAST(120000 AS Decimal(18, 0)))
INSERT [dbo].[Product] ([ProductID], [ProductName], [Unit], [BuyPrice],
[SellPrice]) VALUES (N'Product3', N'S n ph m 3', N'Cái', CAST(40000 AS
Decimal(18, 0)), CAST(70000 AS Decimal(18, 0)))
INSERT [dbo].[Product] ([ProductID], [ProductName], [Unit], [BuyPrice],
[SellPrice]) VALUES (N'Product4', N'S n ph m 4', N'H p', CAST(200000 AS
